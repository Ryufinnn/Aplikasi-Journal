...
<form class='form-horizontal' action='input_kepala.php' method='POST'  enctype='multipart/form-data'>
	  <fieldset>
	...
	<div class='control-group'>
		<label class='control-label' for='input01'></label>
	      <div class='controls'>
	       <button type='submit' name="simpan" class='btn btn-success' rel='tooltip' title='first tooltip'>Save</button> <a href="media.php?module=lihat_dosen" class='btn btn-warning'> Close</a>
