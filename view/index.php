...
<html lang="en">
<head>
  <title>Aplikasi E-Journal</title>
...
<div style="padding-top:2%" class="container-fluid">
	<div class="row-fluid">
		...
		<img style="margin-bottom:2px;" alt="937x250" src="images/header.png" />
					...
					<div class="container-fluid">
						...
						<div class="nav-collapse collapse navbar-responsive-collapse">
							<ul class="nav">
								...
								<?php if ($_SESSION[leveluser] == 'dosen'){ ?>
								...
								<li><a href="media.php?module=tambah_jurnal"><i class="icon-th-large icon-black"></i> Pengajuan Jurnal</a></li>
								<li><a href="media.php?module=lihat_jurnal"><i class="icon-th-large icon-black"></i> Laporan Jurnal</a></li>		
								
									
									
								<?php }elseif ($_SESSION[leveluser] == ''){ ?>
								<li><a href="./"><i class="icon-home icon-black"></i> Home</a></li>
								<li><a href="media.php?module=download"><i class="icon-download icon-black"></i> Download Jurnal</a></li>
								...
								<?php }elseif ($_SESSION[leveluser] == 'admin'){ ?>
									...
									<ul class="dropdown-menu">
									     ...
									     <li><a href="media.php?module=lihat_dosen" >Data Dosen</a></li>
										  <li><a href="media.php?module=lihat_kepala" >Data Kepala</a></li>
										  <li><a href="media.php?module=lihat_user" >Data Admin</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
									     ...
									     <li><a href="media.php?module=edit_visi" >Halaman Utama</a></li>
									...
									<ul class="dropdown-menu">
										...
										<li><a href="laporan_dosen.php" target="_blank">Laporan Data Dosen</a></li>
										<li><a href="laporan_kepala.php" target="_blank">Laporan Kepala</a></li>
										<li><a href="laporan_jurnal.php" target="_blank">Laporan Jurnal Disetujui</a></li>
									...
									<?php }elseif ($_SESSION[leveluser] == 'kepala'){ ?>
									<li><a href="./"><i class="icon-home icon-black"></i> Home</a></li>
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-th-large "></i> File <strong class="caret"></strong></a>
									<ul class="dropdown-menu">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="media.php?module=pemeriksaan_jurnal" >Pemeriksaan Jurnal </a></li>
			...
			<div class="row-fluid">
				...
				?>
					<?php if ($_SESSION[leveluser] == 'admin'){ ?>
						...
						<?php }elseif ($_SESSION[leveluser] == 'dosen'){ ?>
						<div class="span8">
						<?php include "content.php";  ?>
					</div>
					<div class="span4">
			...
			<b>Copyright (c) 2016 - Aplikasi E-Journal</b>
		</center>
		</div>
	</div>
</div>	
